            ...
            <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                ...
                <form className="mt-8 space-y-6" action="#" method="POST">
                    ...
                    <div>
                        ...
                        required
                        className="relative block h-16 w-full appearance-none rounded-none rounded-b-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                    ...
                    <div className="text-sm">
                        <a href="#" className="font-medium text-indigo-400 hover:text-indigo-500 block my-1">
                        Esqueci minha senha?
                        </a>
                        <a href="/signup" className="font-medium text-red-600 hover:text-red-500 block">
